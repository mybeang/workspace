...
tab_1_layout = [
    ...
    [sg.Text('Here is some text.... and a place to enter text'), sg.Text('save me') ],
...
tab_2_layout = [
    [sg.Text("Wow, how simple this is!!!!")]
]

layout = [
    [sg.Menu(menu_def, tearoff=True)],
    [sg.TabGroup([[sg.Tab('tab1', tab_1_layout), sg.Tab('tab2', tab_2_layout)]])]
]
